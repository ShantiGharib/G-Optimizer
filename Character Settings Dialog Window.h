...
String^ Primary_Character_Index = Buff_Settings->ReadLine();
String^ Team_Member_1 = Buff_Settings->ReadLine();
String^ Team_Member_2 = Buff_Settings->ReadLine();
String^ Team_Member_3 = Buff_Settings->ReadLine();
Buff_Settings->Close();
int Character_Check_Count = 0;
int Null_Count = 0;
if (String::CompareOrdinal(Team_Member_1, "Null") == 0) {
Null_Count++;}
if (String::CompareOrdinal(Team_Member_2, "Null") == 0) {
Null_Count++;}
if (String::CompareOrdinal(Team_Member_3, "Null") == 0) {
Null_Count++;}
#define Index_Compare if (String::CompareOrdinal(Team_Member_1,Char_Compare) == 0 || String::CompareOrdinal(Team_Member_2,Char_Compare) == 0 || String::CompareOrdinal(Team_Member_3,Char_Compare) == 0)
...
#define Text_Name(Number) this->comboBox##Number->Text = text_name
#define Check(Number,index,List) ComboBox_Check(Number) { Array_Form(Number,index,List); Visibility(Number); Text_Name(Number);}
for (int i = 0; i<1; i++) {
#define Char_Compare "Albedo"
Index_Compare {
#define text_name L"Burst:Elemental Mastery"
Check(1,2,Array_toggle)
#undef text_name
...
#undef Char_Compare
#define Char_Compare "Alhaitham"
Index_Compare {
#define List {L"3 Stacks", L"2 Stacks", L"1 Stack", L"N/A"})
#define text_name L"C4:Elemental Mastery"
Check(1,4,List)
else Check(2,4,List)
#undef text_name
Character_Check_Count++;
...
#undef Char_Compare
#define Char_Compare "Aloy"
Index_Compare {
#define text_name L"Skill:ATK%"
Check(1,2,Array_toggle)
else Check(2,2,Array_toggle)
else Check(3,2,Array_toggle)
#undef text_name
Character_Check_Count++;
if (Character_Check_Count >= 3 - Null_Count) { 
break;}}
...
#undef Char_Compare
#define Char_Compare "Amber"
Index_Compare {
#define text_name L"C6:Atk% Buff"
Check(1,2,Array_toggle)
else Check(2,2,Array_toggle)
else Check(3,2,Array_toggle)
else Check(4,2,Array_toggle)
#undef text_name
Character_Check_Count++;
if (Character_Check_Count >= 3 - Null_Count) { 
break;}}
...
#undef Char_Compare
#define Char_Compare "Arataki Itto"
Index_Compare { 
Character_Check_Count++;
if (Character_Check_Count >= 3 - Null_Count) { 
break;}}
...
#undef Char_Compare
#define Char_Compare "Arlecchino"
Index_Compare { 
Character_Check_Count++;
if (Character_Check_Count >= 3 - Null_Count) { 
break;}}
...
#undef Char_Compare
#define Char_Compare "Kamisato Ayaka"
Index_Compare { 
Character_Check_Count++;
if (Character_Check_Count >= 3 - Null_Count) { 
break;}}
...
#undef Char_Compare
#define Char_Compare "Kamisato Ayato"
Index_Compare { 
Character_Check_Count++;
if (Character_Check_Count >= 3 - Null_Count) { 
break;}}
...
#undef Char_Compare
#define Char_Compare "Kujou Sara"
Index_Compare { 
Character_Check_Count++;
if (Character_Check_Count >= 3 - Null_Count) { 
break;}}
...
#undef Char_Compare
#define Char_Compare "Kuki Shinobu"
Index_Compare { 
Character_Check_Count++;
if (Character_Check_Count >= 3 - Null_Count) { 
break;}}
...
#undef Char_Compare
#define Char_Compare "Nuevillette"
Index_Compare { 
Character_Check_Count++;
if (Character_Check_Count >= 3 - Null_Count) { 
break;}}
...
#undef Char_Compare
#define Char_Compare "Raiden Shogun"
Index_Compare { 
Character_Check_Count++;
if (Character_Check_Count >= 3 - Null_Count) { 
break;}}
...
#undef Char_Compare
#define Char_Compare "Sangonomiya Kokomi"
Index_Compare { 
Character_Check_Count++;
if (Character_Check_Count >= 3 - Null_Count) { 
break;}}
...
#undef Char_Compare
#define Char_Compare "Wriothesley"
Index_Compare { 
Character_Check_Count++;
if (Character_Check_Count >= 3 - Null_Count) { 
break;}}
